...
class PKDClient {
    ...
    constructor(conf = null, password = null, clearInstance = false) {
        // If PKDClient instance already initiated, return it
    ...
    encrypt(params) {
        ...
        return Promise.all([
            this.getPublicKeys(emails),
            this.getUserKeys()
        ])
        // this will be called when BOTH requests have finished.
            .then(function (results) {
                const keyData = results[0], senderKeyPair = results[1];
                let publicKeys = [];
